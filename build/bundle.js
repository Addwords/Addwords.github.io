...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*ws*/ 4) set_data_dev(t10, /*ws*/ ctx[2]);
    		},
    		i: noop,
    		o: noop,
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ a, b, ws, socket, handleClick });
    	...
    	return [a, b, ws, handleClick, input0_input_handler, input1_input_handler];
    }
